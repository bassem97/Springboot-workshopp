...
public class ClassroomController {
  ...
  ResponseEntity<Response<Classroom>> findAllClassrooms() {
    try {
      ...
      return ResponseEntity
        .badRequest()
        .body(new Response<>(false, 400, e.getMessage(), null));
    }
  }

  @PostMapping("")
  ResponseEntity<Response<Classroom>> addClassroom(
      ...
      return ResponseEntity
        ...
        .body(
          new Response<>(
            ...
            List.of(classroomService.add(classroom))
          )
        );
    } catch (Exception e) {
      return ResponseEntity
  ...
  @PutMapping("/{id}")
  ResponseEntity<Response<Classroom>> updateClassroom(
      ...
      return ResponseEntity
        ...
        .body(
          new Response<>(
            ...
            List.of(classroomService.update(id, classroom))
          )
        );
    } catch (Exception e) {
      return ResponseEntity
  ...
  @DeleteMapping("/{id}")
  ResponseEntity<Response<Classroom>> deleteClassroom(
    @PathVariable("id") Long id
  ) {
    try {
      ...
      return ResponseEntity
        .ok()
        .body(
          new Response<>(true, 200, "Classroom deleted successfully", null)
        );
    } catch (Exception e) {
      return ResponseEntity
        .badRequest()
  ...
  @GetMapping("/{id}")
  ResponseEntity<Response<Classroom>> findClassroomById(
    @PathVariable("id") Long id
  ) {
    try {
      return ResponseEntity
        ...
        .body(
          new Response<>(
            ...
            List.of(classroomService.findById(id))
          )
        );
    } catch (Exception e) {
      return ResponseEntity
  ...
  ResponseEntity<Response<Student>> findStudentsByClassroomName(
      ...
      return ResponseEntity
        ...
        .body(
          new Response<>(
            ...
            classroomService.getStudentsByClassroomName(name)
          )
        );
    } catch (Exception e) {
      return ResponseEntity
